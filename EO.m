...
function [Convergence_curve,Ave,Sd,Min,optimalsol]=EO(Particles_no,Max_iter,lb,ub,dim,fobj,Run_no)
solutions=[];
for irun=1:Run_no
...
Ave=mean(Ceqfit_run);
Sd=std(Ceqfit_run);
[Min, index]=min(Ceqfit_run);
optimalsol=solutions(index,:);
